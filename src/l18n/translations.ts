...
const translations: TTranslations = {
  [ELanguage.EN]: {
    ...
    [EToken.TECH_BLOCKCHAIN]: 'Blockchain solutions',
    [EToken.TECH_BLOCKCHAIN_DESC]: 'Web3 and blockchain development',
    [EToken.TECH_DESKTOP]: 'Cross-platform Desktop apps',
    [EToken.TECH_DESKTOP_DESC]: 'Native desktop applications',
    [EToken.TECH_MOBILE]: 'Cross-platform Mobile apps',
    [EToken.TECH_MOBILE_DESC]: 'Native mobile applications',
    [EToken.TECH_WEB]: 'Full-stack Web solutions',
  ...
  [ELanguage.JA]: {
    ...
    [EToken.TECH_BLOCKCHAIN]: 'ブロックチェーンソリューション',
    [EToken.TECH_BLOCKCHAIN_DESC]: 'Web3とブロックチェーン開発',
    [EToken.TECH_DESKTOP]: 'クロスプラットフォームデスクトップアプリ',
    [EToken.TECH_DESKTOP_DESC]: 'ネイティブデスクトップアプリケーション',
    [EToken.TECH_MOBILE]: 'クロスプラットフォームモバイルアプリ',
    [EToken.TECH_MOBILE_DESC]: 'ネイティブモバイルアプリケーション',
    [EToken.TECH_WEB]: 'フルスタックWebソリューション',
